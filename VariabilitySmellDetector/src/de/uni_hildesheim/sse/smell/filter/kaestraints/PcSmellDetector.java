 ...
 */
public class PcSmellDetector extends AbstractSatSolverFilter {

    public PcSmellDetector(String dimacsModelFile) throws IOException {
...
//                    xorTrees.add(new OCLFeatureCall(trueCst, OclKeyWords.XOR, falseCst));
                ...
                if (solvable) {
                     ...
                     * true results).
                     */
                    IDataElement r = buildResult(pcs, constr);
                    result.add(r);
                }
